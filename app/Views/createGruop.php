 ...
 <body class="  ">
   ...
   <div class="row">
     ...
     <div style="position:fixed;left:0;top:0;bottom:0" class=" bg-light col-sm-3">
       ...
       <!-- // ---------------------------------------------------------------- -->
       <a class="alert bg-info text-light" href="gruop">Quay lại </a>
       <div>
           <br>
           <br>
           <p class="text-center">Nhập thông tin </p>
           <form action="store_gr" method="post" enctype="multipart/form-data"> 
               <label for="dsfhdhfhs">Tên nhóm</label>
               <input  class="form-control" id="dsfhdhfhs"  type="text"  name="name" value="">
               <?php if(isset($_SESSION['msg'])){ ?>
                <p class="alert alert-danger"><?= $_SESSION['msg'] ?></p>
               <?php $_SESSION['msg'] = null ; } ?>
               <label for="dsfdsfdsfdsfs">Quyền riêng tư</label>
              <select class="form-control" id="dsfdsfdsfdsfs" name="status">
                  <option class="form-control" value="0">Công khai</option>
                  <option class="form-control" value="1">Nhóm kín</option>
              </select>
               <!-- <label for="dsfhdhfhs">Mời bạn bè</label>
               <input class="form-control" id="dsfhdhfhs"  type="text"  name="name" value=""> -->
               <br>
               <button class="btn btn-primary"type="submit">Bước tiếp theo</button>
            </form>
       </div>
     </div>
     <div class="col-sm-9 row"> 
         <div class="col-sm-3"> 
          ...
          <div class="col-sm-6 bg-light rounded p-3">
              <img width="100%" height="400" src="https://cdn.cms-twdigitalassets.com/content/dam/blog-twitter/official/en_us/products/2017/rethinking-our-default-profile-photo/Avatar-Blog2-Round1.png.img.fullhd.medium.png" alt="">
                <h5 id="showttg" class="m-3">Tên nhóm</h5> 
                <p  class="mx-3">Quyền riêng tư : <strong id="shs_ssd" >Công khai</strong> </p>
                <hr>
        </div>
          <div class="col-sm-3"> 
             </div>
         ...
         <script>
             $(document).ready(function() {
                 $('#dsfhdhfhs').on('input', function(){
                    //  alert('121212');
                    $('#showttg').html($(this).val());
                 })
                 $('#dsfdsfdsfdsfs').on('change', function(){
                     if($(this).val() == 0){
                        $('#shs_ssd').html('Công khai');
                     }else{
                         $('#shs_ssd').html('Riêng tư'); 
                     }
                 })
             })
         </script>
