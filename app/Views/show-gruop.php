  ...
  <div class="row">
    <div class="col-sm-12 row">
      <div class="col-sm-3  bg-light" > 
        ...
        <div style="  overflow:auto ; padding-top:30px ; padding-left:40px" class="row   col-sm-12 ">
          <h3 class="alert  text-center text-bold text-info">Gruop of me</h3>
          <?php
          ...
          ?>
            <a href="show-gruop?id=<?= $val['id'] ?>" class="row my-2 bg-light border border-info p-2 rounded text-dark">
              ...
              <p class="  col-sm-9"><?= $val['name']  ?> <br> <small style="color: #ccc"> <?= count($ghhas) - 1 ?> Thành viên</small> </p>

            </a>
          <?php } ?>
        </div>
      </div>
      <div class="col-sm-6 bg-light rounded p-3">
        <div id="showbanner" style="width:100% ; height:500px ; position:relative;">
          <img width="100%" height="100%" src="<?php
                                                if ($model['banner'] == null) {
                                                  echo 'https://cdn.cms-twdigitalassets.com/content/dam/blog-twitter/official/en_us/products/2017/rethinking-our-default-profile-photo/Avatar-Blog2-Round1.png.img.fullhd.medium.png';
                                                } else {
                                                  echo './upload/' . $model['banner'];
                                                }

                                                ?>" alt="">
          <form id="bbggdd" enctype="multipart/form-data" method="post">
            <input type="hidden" name="id" value="<?= $model['id'] ?>">
            <input style="display: none" id="bngr" type="file" name="bngr" value="">
          </form>
          <label for="bngr" style="width:50px; position:absolute ; bottom : 1% ; right : 1%">
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="upload" class="svg-inline--fa fa-upload fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              <path fill="blue" d="M296 384h-80c-13.3 0-24-10.7-24-24V192h-87.7c-17.8 0-26.7-21.5-14.1-34.1L242.3 5.7c7.5-7.5 19.8-7.5 27.3 0l152.2 152.2c12.6 12.6 3.7 34.1-14.1 34.1H320v168c0 13.3-10.7 24-24 24zm216-8v112c0 13.3-10.7 24-24 24H24c-13.3 0-24-10.7-24-24V376c0-13.3 10.7-24 24-24h136v8c0 30.9 25.1 56 56 56h80c30.9 0 56-25.1 56-56v-8h136c13.3 0 24 10.7 24 24zm-124 88c0-11-9-20-20-20s-20 9-20 20 9 20 20 20 20-9 20-20zm64 0c0-11-9-20-20-20s-20 9-20 20 9 20 20 20 20-9 20-20z"></path>
            </svg>
          </label>
        </div>
        <script>
          $(document).ready(function() {
            $('#bbggdd').on('change', function() {
              $.ajax({
                url: ('loadBaner'),
                method: 'POST',
        ...
        <h5 id="showttg" class="m-3"><?php echo $model['name'] ?></h5>
        <p class="mx-3">Quyền riêng tư : <strong id="shs_ssd"><?php
                                                              if ($model['status'] == 0) {
                                                                echo 'Công khai';
                                                              } else {
                                                                echo 'Nhóm kín';
                                                              ...
                                                              ?></strong> </p>
        <p class="mx-3">Thành viên : <strong id="shs_ssd"><?php
                                                          echo count(explode(",", $model['member'])) - 1;
                                                          ?></strong> </p>
        <hr>
        <div class="col-sm-12">
          <!--  -->
          <form class="input-group " action="createPost" method="post" enctype="multipart/form-data">
              ...
              <input id="ig" style="display:none" class="form-control" multiple type="file" name="image[]" value="">
              <input type="hidden" name="id_gruop" value="<?php echo  $model['id'] ?>">
              <button class="btn btn-primary element-3" type="">Dang bai</button>
            </form>
            <label style="width:30px;height:30px" for="ig">
             <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="images" class="svg-inline--fa fa-images fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
