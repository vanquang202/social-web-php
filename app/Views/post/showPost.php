         ...
         <div class="container bg-light">
             <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                 ...
                 <button style="width:45px ;height:45px; border-radius:50%;background:#ccc;margin:10px"
                     class="btn position-relative " type="button">
                     ...
                     <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
                         ...
                         <li class="text-center">
                             ...
                             <div class="qr-overview">
                                 <sl-qr-code value="https://shoelace.style/"
                                     label="Scan this code to visit Shoelace on the web!"></sl-qr-code>
                                 <br>
     ...
     <div class="row">
         ...
         <div class="col-sm-6">
             <div style="background:none" class="container dd card border mb-3">
                 ...
                 <div id="showhhPost" class="container">
                 </div>
                 <input type="hidden" class="inputGet" name="" value="<?= $errors ?>">
             </div>
